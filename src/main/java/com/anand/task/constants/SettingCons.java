...
public class SettingCons {
	...
	public static final String TOOL_NAME	 = "File Share";
	...
	public static final String LOG_FOLDER_PATH   = CURRENT_DIR+"/FileShareWeb_Logs/";
	public static final String LOG_PROPERTY_PATH = CURRENT_DIR+"/AdminProperty/FSW_LogFormatter.properties";
